var U=o=>{throw TypeError(o)};var M=(o,e,t)=>e.has(o)||U("Cannot "+t);var c=(o,e,t)=>(M(o,e,"read from private field"),t?t.call(o):e.get(o)),p=(o,e,t)=>e.has(o)?U("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),L=(o,e,t,s)=>(M(o,e,"write to private field"),s?s.call(o,t):e.set(o,t),t),b=(o,e,t)=>(M(o,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();class j{constructor(){this.app=document.getElementById("app")||document.body}getTemplate(){return`
            ...
            <div class="form-group">
              ...
              <div class="password-input-container">
                ...
                <button type="button" id="toggle-password" class="toggle-password" aria-label="Show password">
                  <img src="/Story-app/images/visible.svg" alt="show password icon">
                </button>
              </div>
    ...
    `;s&&(r+=`
      ...
      `),r+="</div>",i.innerHTML=r}animateStoryElements(){const e=document.querySelector(".detail-story-header"),t=document.querySelector(".detail-story-image"),s=document.querySelector(".detail-story-content"),i=document.querySelector(".detail-story-location");e&&I(e,[{opacity:0,transform:"translateY(-20px)"},{opacity:1,transform:"translateY(0)"}],{duration:600,easing:"cubic-bezier(0.2, 0, 0.2, 1)",fill:"forwards"}),t&&I(t,[{opacity:0,transform:"scale(0.95)"},{opacity:1,transform:"scale(1)"}],{duration:800,easing:"cubic-bezier(0.2, 0, 0.2, 1)",fill:"forwards",delay:200}),s&&I(s,[{opacity:0,transform:"translateY(20px)"},{opacity:1,transform:"translateY(0)"}],{duration:600,easing:"cubic-bezier(0.2, 0, 0.2, 1)",fill:"forwards",delay:400}),i&&I(i,[{opacity:0,transform:"translateY(20px)"},{opacity:1,transform:"translateY(0)"}],{duration:600,easing:"cubic-bezier(0.2, 0, 0.2, 1)",fill:"forwards",delay:600})}animateMapContainer(){const e=document.getElementById("story-map");e&&I(e,[{opacity:0,transform:"scale(0.95)"},{opacity:1,transform:"scale(1)"}],{duration:800,easing:"ease-out",fill:"forwards"})}}class Se{async getStoryDetail(e){try{return(await Y(e)).story}catch(t){throw new Error(`Failed to fetch story details: ${t.message}`)}}isUserLoggedIn(){return!!localStorage.getItem("token")}getUserName(){return localStorage.getItem("name")||"User"}}class Ee{constructor(e,t,s){this.view=e,this.model=t,this.mapHandler=s}async init(e){if(!this.model.isUserLoggedIn()){this.view.showLoginMessage();return}const t=this.model.getUserName();if(this.view.showAuthenticatedUser(t),!e){this.view.showError("Story ID not found in URL");return}try{this.view.showLoading();const s=await this.model.getStoryDetail(e);if(!s){this.view.showError("Story not found");return}const i=ve(s.createdAt),r=!!(s.lat&&s.lon);this.view.displayStory(s,i,r),this.view.animateStoryElements(),r&&await this.initializeMap(s)}catch(s){this.view.showError(s.message),console.error("Error loading story:",s)}}async initializeMap(e){try{(await this.mapHandler.init("story-map",{center:[e.lat,e.lon],zoom:15})).success&&(this.mapHandler.setMarker(e.lat,e.lon),this.view.animateMapContainer())}catch(t){console.error("Error initializing map:",t)}}}class Le{constructor(){this.view=new be,this.model=new Se,this.mapHandler=new D,this.presenter=null}async render(){return this.view.getTemplate()}async afterRender(){this.presenter=new Ee(this.view,this.model,this.mapHandler);const{id:e}=ye();await this.presenter.init(e)}}class Ie{getTemplate(){return`
      <section class="container">
